...
def handle_argv(target, config_train, prefix):
    ...
    parser.add_argument('dataset', type=str, help='Dataset name', choices=['hhar', 'motion', 'uci', 'shoaib', \
                                                                           'littlebeats_train', 'littlebeats_val', 'littlebeats_test', 'littlebeats_train_1', 'littlebeats_train_2', 'littlebeats_train_3', \
                                                                           'littlebeats_pretrain'])
    parser.add_argument('dataset_version',  type=str, help='Dataset version', choices=['10_100', '20_120', '150_4500'])
